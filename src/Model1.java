...
public class Model1 {
	private String numeroTele,codeFidelio,typeCarte,nomBank,numCarte,moisExperie,AnneeExperie,codeCarte;
	private static String email="";
	
	public Model1() {
		numeroTele = codeFidelio = typeCarte = nomBank = numCarte = moisExperie = AnneeExperie = codeCarte = "";
	}
